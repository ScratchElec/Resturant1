...
/**
 * Created by Mahmoud Ellawatty on 14/07/2016.
 */
public class SendData extends AsyncTask<String,Context,Void> {
    ...
    public SendData(SharedPreferences sharedPreferences,Context context){
    ...
    private void executeCode() {
        SharedPreferencesArray preferencesArray = new SharedPreferencesArray(context);
