...
public class AllCAfes extends Activity implements View.OnClickListener {

	String whichOne;
	ImageView v;
	int move=0;

    ImageButton menuBar,Three;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		case "bn":
			...
			img.setImageResource(CustomAdapter.bn[move]);
		    break;
		...
		my.addView(A);
            ...
            if(isConnected(getApplicationContext())){
                Toast.makeText(getApplicationContext(), String.valueOf("CAFES"), Toast.LENGTH_LONG).show();
	...
	private void Imagenow(int move2,String who) {
		...
		TouchImageView img = new TouchImageView(this);
		LinearLayout my = (LinearLayout) findViewById(R.id.imageView);
		LinearLayout A1 = new LinearLayout(AllCAfes.this);
		my.removeAllViews();
		A1.removeAllViews();
		A1.addView(img);
		my.addView(A1);
		...
		{
		case "bn":
			if(move2>=CustomAdapter.bn.length-1)
                move2=CustomAdapter.bn.length-1;
		    img.setImageResource(CustomAdapter.bn[move2]);
		    my.removeAllViews();
			   A1.removeAllViews();
			   A1.addView(img);
				my.addView(A1);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		/*case R.id.menubar:
			...
			PopupMenu popm=new PopupMenu(AllCAfes.this,mm);
			...
			popm.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
				...
				public boolean onMenuItemClick(MenuItem item) {
					...
					{
					case R.id.menurest:
						Intent i = new Intent(AllCAfes.this,Rest.class);
						startActivity(i);
						break;
					case R.id.menucafe:
						Intent i1 = new Intent(AllCAfes.this,Pat.class);
						startActivity(i1);
						break;
						
					case R.id.menupat:
						Intent i11 = new Intent(AllCAfes.this,Cafes.class);
						startActivity(i11);
						break;
					case R.id.menuice:
						Intent i12 = new Intent(AllCAfes.this,Ice.class);
						startActivity(i12);
						break;
		...
		case R.id.settings:
			...
			PopupMenu popm1=new PopupMenu(AllCAfes.this,mn);
			...
			popm1.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
				...
				public boolean onMenuItemClick(MenuItem item) {
					...
					case R.id.menucreates:
						Intent i = new Intent(AllCAfes.this,Names.class);
						startActivity(i);
						break;
