...
public class AllIce extends Activity implements OnClickListener{
	...
	//		AdBuddiz.showAd(this);
		    img.setImageResource(CustomAdapter.ft[move]);
		    break;
		case "rsh":
	//		AdBuddiz.setPublisherKey("3bbc3558-c5c9-4a70-a2a4-bc9d411df6cc");
	//		AdBuddiz.cacheAds(this);
	//		AdBuddiz.showAd(this);
		    img.setImageResource(CustomAdapter.rsh[move]);
		    break;
		case "kok":
	//		AdBuddiz.setPublisherKey("3bbc3558-c5c9-4a70-a2a4-bc9d411df6cc");
	//		AdBuddiz.cacheAds(this);
	//		AdBuddiz.showAd(this);
		    img.setImageResource(CustomAdapter.kok[move]);
		    break;
		case "robin":
	//		AdBuddiz.setPublisherKey("3bbc3558-c5c9-4a70-a2a4-bc9d411df6cc");
	//		AdBuddiz.cacheAds(this);
	//		AdBuddiz.showAd(this);
		    img.setImageResource(CustomAdapter.robin[move]);
		    break;
		case "nine":
	//		AdBuddiz.setPublisherKey("3bbc3558-c5c9-4a70-a2a4-bc9d411df6cc");
	//		AdBuddiz.cacheAds(this);
	//		AdBuddiz.showAd(this);
		    img.setImageResource(CustomAdapter.nine[move]);
		    break;
		...
		my.addView(A);
            ...
            if(isConnected(getApplicationContext())){
                Toast.makeText(getApplicationContext(), String.valueOf("ICE"), Toast.LENGTH_LONG).show();
	...
	public void onClick(View v) {
		...
		case R.id.call:
            ...
            case R.id.menuMenu:
                ...
                PopupMenu popm=new PopupMenu(AllIce.this,mm);
                ...
                popm.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        {
                            case R.id.menurest:
                                Intent i = new Intent(AllIce.this,Rest.class);
                                startActivity(i);
                                break;
                            case R.id.menucafe:
                                Intent i1 = new Intent(AllIce.this,Pat.class);
                                startActivity(i1);
                                break;

                            case R.id.menupat:
                                Intent i11 = new Intent(AllIce.this,Cafes.class);
                                startActivity(i11);
                                break;
                            case R.id.menuice:
                                Intent i12 = new Intent(AllIce.this,Ice.class);
                                startActivity(i12);
                                break;
            ...
            case R.id.threeMenu:
                ...
                PopupMenu popm1=new PopupMenu(AllIce.this,mn);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch(item.getItemId())
                        {
                            ...
                            case R.id.menucreates:
                                Intent i = new Intent(AllIce.this,Names.class);
                                startActivity(i);
                                break;
	...
	private void Imagenow(int move2,String who) {
		...
		TouchImageView img = new TouchImageView(this);
		LinearLayout my = (LinearLayout) findViewById(R.id.imageView);
		LinearLayout A1 = new LinearLayout(AllIce.this);
		my.removeAllViews();
		A1.removeAllViews();
		A1.addView(img);
		my.addView(A1);
		...
		{
		case "ft":
			if(move2>=CustomAdapter.ft.length-1)
                move2=CustomAdapter.ft.length-1;
		    img.setImageResource(CustomAdapter.ft[move2]);
		    my.removeAllViews();
			   A1.removeAllViews();
			   A1.addView(img);
				my.addView(A1);
		    break;
		case "robin":
            if(move2>=CustomAdapter.robin.length-1)
                move2=CustomAdapter.robin.length-1;
		    img.setImageResource(CustomAdapter.robin[move2]);
		    my.removeAllViews();
			   A1.removeAllViews();
			   A1.addView(img);
				my.addView(A1);
		    break;
		case "rsh":
			if(move2>=CustomAdapter.rsh.length-1)
                move2=CustomAdapter.rsh.length-1;
		    img.setImageResource(CustomAdapter.rsh[move2]);
		    my.removeAllViews();
			   A1.removeAllViews();
			   A1.addView(img);
				my.addView(A1);
		    break;
		case "kok":
			if(move2>=CustomAdapter.kok.length-1)
                move2=CustomAdapter.kok.length-1;
		    img.setImageResource(CustomAdapter.kok[move2]);
		    my.removeAllViews();
			   A1.removeAllViews();
			   A1.addView(img);
				my.addView(A1);
		    break;
		case "nine":
			if(move2>=CustomAdapter.nine.length-1)
                move2=CustomAdapter.nine.length-1;
		    img.setImageResource(CustomAdapter.nine[move2]);
		    my.removeAllViews();
			   A1.removeAllViews();
			   A1.addView(img);
				my.addView(A1);
